...
for(const label of ['Projects','New project','Discovery','Documents','Analysis','Solution','Red Team','Blueprint','Deliverables','Teams & admin','Transformation','Email address','Password','Full name','Confirm password','Create account','Sign in','Welcome back.','Create your workspace.','Sign in to workspace','Please wait…','Business analysis','Architecture design','Process intelligence','Experience design','Database and API design','Delivery and estimation','Transformation strategy'])labels.add(label);
