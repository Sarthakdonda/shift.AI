...
- After completing a feature or fix, remove any test files, verification scripts, and testing artifacts created for that task unless the user explicitly asks to keep them. Preserve pre-existing project tests.
